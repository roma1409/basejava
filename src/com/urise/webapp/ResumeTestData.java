...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullName) {
        ...
        OrganizationListSection experience = new OrganizationListSection();
        ...
        experience.addOrganization(javaOps);
        ...
        experience.addOrganization(wrike);
        ...
        experience.addOrganization(rit);
        grigoriy.addSection(EXPERIENCE, experience);

        OrganizationListSection education = new OrganizationListSection();
        ...
        education.addOrganization(coursera);
        Organization luxoft = new Organization("Luxoft", "http://www.luxoft.ru/");
        ...
        education.addOrganization(luxoft);
        ...
        education.addOrganization(siemensAg);
        ...
        education.addOrganization(alcatel);
        ...
        education.addOrganization(itmo);
        ...
        education.addOrganization(mfti);
